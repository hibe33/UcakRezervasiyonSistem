...
public class f1 extends javax.swing.JFrame {
    ...
    private static final String CONN_STRING="jdbc:mysql://localhost:3306/mydata22";
    /**
     * Creates new form f1
     */
    public f1() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            if("root".equals(a)&&"0629".equals(b)){
                new f5().setVisible(true);
            }
        }catch(Exception x){
            JOptionPane.showMessageDialog(null,"error while e c");
        }
